...
The program "server_old.go" is the Master node, it is a basic TCP server which is used to check if the file eval_wasm exists in the "master" directory and then requests the client to transfer the file. 
...
The Test.zip file contains the following:
